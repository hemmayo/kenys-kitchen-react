...
!function(t, e) {
    ...
    function P(t) {
        return E(t) || I(t) || S(t) ? t : A(t) || T(t) ? t[0] : y(t) ? P(t[0]) : null
    }
    var L = Array.prototype;
    function j(t) {
        return E(t) ? [t] : A(t) ? L.slice.call(t) : y(t) ? t.map(P).filter(Boolean) : T(t) ? t.toArray() : []
    }
    function W(t) {
        return y(t) ? t : N(t) ? t.split(/,(?![^(]*\))/).map(function(t) {
            return O(t) ? z(t) : D(t.trim())
        }) : [t]
    }
    function F(t) {
        return t ? u(t, "ms") ? H(t) : 1e3 * H(t) : 0
    }
    function V(t, e, i) {
    ...
    function ot(t, e) {
        return P(at(t, e, "querySelector"))
    }
    function st(t, e) {
        return j(at(t, e, "querySelectorAll"))
    }
    function at(t, s, e) {
        if (void 0 === s && (s = document), !t || !N(t))
            return null;
        var a;
    ...
    function gt(t, e) {
        for (var i = [], n = P(t).parentNode; n && 1 === n.nodeType;)
    ...
    function St(t, e) {
        return N(e) ? ft(t, e) || mt(t, e) : t === e || (S(e) ? e.documentElement : P(e)).contains(P(t))
    }
    function Tt() {
        ...
        var i,
            ...
            a = n[3],
            l = n[4];
        return r = Bt(r), s && (a = function(t, n, r) {
            var o = this;
            return function(i) {
    ...
    function Et(t, e, i, n) {
        void 0 === n && (n = !1), t = Bt(t), e.split(" ").forEach(function(e) {
            return t.forEach(function(t) {
    ...
    function Bt(t) {
        return y(t) ? t.map(Ot).filter(Boolean) : N(t) ? st(t) : Mt(t) ? [t] : j(t)
    }
    function Dt() {
    ...
    function jt(t) {
        this.state = Pt, this.value = void 0, this.deferred = [];
        var e = this;
        try {
            t(function(t) {
                e.resolve(t)
    ...
    function ie(t, e) {
        return e ? j(t).indexOf(P(e)) : j((t = P(t)) && t.parentNode.children).indexOf(t)
    }
    function ne(t, e, i, n) {
        void 0 === i && (i = 0), void 0 === n && (n = !1);
        var r = (e = j(e)).length;
        return t = O(t) ? z(t) : "next" === t ? i + 1 : "previous" === t ? i - 1 : ie(e, t), n ? U(t, 0, r - 1) : (t %= r) < 0 ? t + r : t
    }
    function re(t) {
    ...
    function ve(t, e) {
        if (t && 1 === t.nodeType)
            for (e(t), t = t.firstElementChild; t;)
                ve(t, e), t = t.nextElementSibling
    }
    function we(t, e) {
        return N(t) ? ye(t) ? P(ge(t)) : ot(t, e) : P(t)
    }
    function be(t, e) {
        ...
        if (n.length) {
            ...
            n = n.filter(Boolean), j(t).forEach(function(t) {
                for (var e = t.classList, i = 0; i < n.length; i++)
                    _e.Force ? e.toggle.apply(e, [n[i]].concat(r)) : e[(B(r) ? !e.contains(n[i]) : r) ? "add" : "remove"](n[i])
            })
        }
    }
    function Ee(t, i, n) {
    ...
    function Me(t, e, r) {
        return j(t).map(function(i) {
            if (N(e)) {
                if (e = Pe(e), B(r))
                    return Be(i, e);
                r || 0 === r ? i.style[e] = O(r) && !Ne[e] ? r + "px" : r : i.style.removeProperty(e)
            } else {
                if (y(e)) {
                    var n = Oe(i);
    ...
    function Oe(t, e) {
        return (t = P(t)).ownerDocument.defaultView.getComputedStyle(t, e)
    }
    function Be(t, e, i) {
        return Oe(t, i)[e]
    }
    ...
    function ze(t) {
        ...
        if (!Yt)
            return Oe(e).getPropertyValue("--uk-" + t);
        if (!(t in De)) {
            var i = se(e, document.createElement("div"));
            xe(i, "uk-" + t), De[t] = Be(i, "content", ":before").replace(/^["'](.*)["']$/, "$1"), ce(i)
        }
        return De[t]
    }
    var He = {};
        ...
        return void 0 === a && (a = 400), void 0 === l && (l = "linear"), zt.all(j(t).map(function(o) {
            return new zt(function(i, n) {
                ...
                Ct(o, "transitionend transitioncanceled", function(t) {
                    ...
                    "transition-property": Object.keys(s).map(Pe).join(","),
    ...
    function Ke(t, e, c, u, d, i, f, p) {
        ...
        return ni(w, c, g, -1), ni(w, u, v, 1), d = oi(d, g.width, g.height), i = oi(i, v.width, v.height), d.x += i.x, d.y += i.y, w.left += d.x, w.top += d.y, p = Je(p || ui(t)), f && R(Xe, function(t, n) {
            ...
            function h(e, t) {
                var i = w[o] + e + t - 2 * d[r];
                if (i >= p[o] && i + g[n] <= p[s])
                    return w[o] = i, ["element", "target"].forEach(function(t) {
    ...
    function Ge(i, n) {
        ...
        ["left", "top"].forEach(function(t) {
            if (t in n) {
                var e = Me(i, t);
                Me(i, t, n[t] - r[t] + H("absolute" === o && "auto" === e ? Ze(i)[t] : e))
            }
        })
    }
    function Je(t) {
    ...
    function Ze(n) {
        var r = (n = P(n)).offsetParent || di(n).documentElement,
            o = Ge(r),
            t = ["top", "left"].reduce(function(t, e) {
                var i = a(e);
                return t[e] -= o[e] + H(Me(n, "margin" + i)) + H(Me(r, "border" + i + "Width")), t
            }, Ge(n));
        return {
            top: t.top,
            left: t.left
    ...
    function ei(n) {
        ...
        return function(t, e) {
            if (t = P(t), B(e)) {
                ...
                return (e = "auto" === (e = Me(t, n)) ? t["offset" + r] : H(e) || 0) - ii(n, t)
            }
    ...
    function ii(t, i, e) {
        return void 0 === e && (e = "border-box"), Me(i, "boxSizing") === e ? Xe[t].slice(1).map(a).reduce(function(t, e) {
            return t + H(Me(i, "padding" + e)) + H(Me(i, "border" + e + "Width"))
        }, 0) : 0
    }
    function ni(o, s, a, l) {
        R(Xe, function(t, e) {
    ...
    function oi(t, e, i) {
        var n = (t || "").split(" "),
            ...
            o = n[1];
        return {
            x: r ? H(r) * (u(r, "%") ? e / 100 : 1) : 0,
            y: o ? H(o) * (u(o, "%") ? i / 100 : 1) : 0
        }
    }
    function si(t) {
        switch (t) {
    ...
    function ai(t, e, i, n) {
        if (void 0 === e && (e = 0), void 0 === i && (i = 0), !xt(t))
            return !1;
        var r,
            o,
            s = ui(t = P(t));
        if (n)
            r = t.getBoundingClientRect(), o = {
                top: -e,
                left: -i,
                bottom: e + Qe(s),
                right: i + ti(s)
    ...
    bi.args = bi.events = bi.created = bi.beforeConnect = bi.connected = bi.beforeDisconnect = bi.disconnected = bi.destroy = function(t, e) {
        return t = t && !y(t) ? [t] : t, e ? t ? t.concat(e) : y(e) ? e : [e] : t
    }, bi.update = function(t, e) {
        return q(bi.args(t, x(e) ? {
            read: e
        } : e), "order")
        ...
        try {
            return t ? v(t, "{") ? JSON.parse(t) : e.length && !b(t, ":") ? ((i = {})[e[0]] = t, i) : t.split(";").reduce(function(t, e) {
                var i = e.split(/:(.*)/),
                    n = i[0],
                    r = i[1];
                return n && !B(r) && (t[n.trim()] = r.trim()), t
            }, {}) : {}
        } catch (t) {
            return {}
        }
    ...
    Fi.util = Object.freeze({
    ...
    }(Fi), (Pi = Fi).prototype._callHook = function(t) {
        var e = this,
            i = this.$options[t];
        i && i.forEach(function(t) {
            return t.call(e)
        })
    }, Pi.prototype._callConnected = function() {
    ...
    }, Pi.prototype._callDisconnected = function() {
        this._connected && (this._callHook("beforeDisconnect"), this._observer && (this._observer.disconnect(), this._observer = null), this._unbindEvents(), this._callHook("disconnected"), this._connected = !1)
    }, Pi.prototype._callUpdate = function(o) {
        var s = this,
        ...
        function s(t, e) {
            ...
            for (var s in r) {
                var a = m(s),
                    l = et(o, a);
                if (!B(l)) {
                    if (l = r[s] === Boolean && "" === l || d(r[s], l), "target" === a && (!l || v(l, "_")))
                        continue;
                    i[s] = l
                }
            }
        ...
        t.prototype._init = function(t) {
            (t = t || {}).data = function(t, e) {
                ...
                if (void 0 === r && (r = {}), i = y(i) ? n && n.length ? i.slice(0, n.length).reduce(function(t, e, i) {
                    ...
                    for (var o in i)
                        B(i[o]) ? delete i[o] : i[o] = r[o] ? d(r[o], i[o]) : i[o];
                return i
    ...
    }(Fi), ji = (Li = Fi).data, Wi = {}, Li.component = function(s, t) {
        if (!t)
            return $(Wi[s]) && (Wi[s] = Li.extend(Wi[s])), Wi[s];
        Li[s] = function(t, i) {
        ...
        if (t[ji])
            for (var e in t[ji])
                t[ji][e]._callConnected();
        for (var i = 0; i < t.attributes.length; i++) {
            var n = Hi(t.attributes[i].name);
            n && n in Wi && Li[n](t)
        }
    }, Li.disconnect = function(t) {
        for (var e in t[ji])
            t[ji][e]._callDisconnected()
    }, function(n) {
        var r = n.data;
        ...
        Yi = {
            ...
            methods: {
                ...
                _toggleElement: function(t, e, i) {
                    var n = this;
                    if (e = _(e) ? e : Ue.inProgress(t) ? Se(t, "uk-animation-leave") : Fe.inProgress(t) ? "0px" === t.style.height : !this.isToggled(t), !At(t, "before" + (e ? "show" : "hide"), [this]))
                        return zt.reject();
                    var r = (!1 !== i && this.hasAnimation ? this.hasTransition ? this._toggleHeight : this._toggleAnimation : this._toggleImmediate)(t, e);
                    return At(t, e ? "show" : "hide", [this]), r.then(function() {
                ...
                _toggleHeight: function(t, e) {
                    var i = this,
                        n = Fe.inProgress(t),
                        r = t.hasChildNodes ? H(Me(t.firstElementChild, "marginTop")) + H(Me(t.lastElementChild, "marginBottom")) : 0,
                        o = xt(t) ? Qe(t) + (n ? 0 : r) : 0;
                    Fe.cancel(t), this.isToggled(t) || this._toggle(t, !0), Qe(t, ""), fi.flush();
                    var s = Qe(t) + (n ? 0 : r);
                    return Qe(t, o), (e ? Fe.start(t, Y({}, this.initProps, {
                        overflow: "hidden",
                        height: s
                    }), Math.round(this.duration * (1 - o / s)), this.transition) : Fe.start(t, this.hideProps, Math.round(this.duration * (o / s)), this.transition).then(function() {
                        return i._toggle(t, !1)
                    })).then(function() {
                        return Me(t, i.initProps)
                    })
                },
                _toggleAnimation: function(t, e) {
                    var i = this;
                    return Ue.cancel(t), e ? (this._toggle(t, !0), Ue.in(t, this.animation[0], this.duration, this.origin)) : Ue.out(t, this.animation[1] || this.animation[0], this.duration, this.origin).then(function() {
                        return i._toggle(t, !1)
                    })
                }
            }
        ...
        Ri = {
            ...
            update: function() {
                ...
                this.items.forEach(function(t) {
                    return e._toggleImmediate(we(e.content, t), Se(t, e.clsOpen))
                });
                ...
                toggle: function(r, o) {
                    ...
                    (r = this.items[t]) && [r].concat(!this.multiple && !b(a, r) && a || []).forEach(function(t) {
                        ...
                        if (i || !e || s.collapsible || !(a.length < 2)) {
                            ...
                            t._wrapper || (t._wrapper = ue(n, "<div>"), Z(t._wrapper, "hidden", i ? "" : null)), s._toggleImmediate(n, !0), s.toggleElement(t._wrapper, i, o).then(function() {
                                Se(t, s.clsOpen) === i && (i || s._toggleImmediate(n, !1), t._wrapper = null, fe(n))
                            })
                        }
                    })
                }
    ...
    var Xi,
        ...
        Zi = {
            ...
            methods: {
                positionAt: function(t, e, i) {
                    ...
                    var r = this.offset;
                    r = O(r) ? r : (n = we(r)) ? Ge(n)["x" === o ? "left" : "top"] - Ge(e)["x" === o ? "right" : "bottom"] : 0;
                    var o = this.getAxis(),
                        s = Ke(t, e, "x" === o ? si(this.dir) + " " + this.align : this.align + " " + si(this.dir), "x" === o ? this.dir + " " + this.align : this.align + " " + this.dir, "x" === o ? "" + ("left" === this.dir ? -r : r) : " " + ("top" === this.dir ? -r : r), null, this.flip, i).target,
                        a = s.x,
                        l = s.y;
        ...
        Qi = {
            ...
            events: [{
                ...
                handler: function(t) {
                    Bi(t) || (Xi && Xi !== this && Xi.toggle && b(Xi.toggle.mode, "hover") && !St(t.target, Xi.toggle.$el) && !G({
                        x: t.pageX,
                        y: t.pageY
                ...
                name: "togglehide " + Qt,
                handler: function(t, e) {
                    Bi(t) || e && !b(e.target, this.$el) || (t.preventDefault(), this.toggle && b(this.toggle.mode, "hover") && this.hide())
                }
            }, {
                name: "beforeshow",
                self: !0,
                ...
                self: !0,
                handler: function() {
                    this.tracker.init(), this.toggle && (xe(this.toggle.$el, this.cls), Z(this.toggle.$el, "aria-expanded", "true")), function() {
                        if (Ki)
                            return;
                        Ki = !0, Tt(document, "click", function(t) {
                            ...
                            if (!n)
                                for (; Xi && Xi !== e && !St(i, Xi.$el) && (!Xi.toggle || !St(i, Xi.toggle.$el));)
                                    (e = Xi).hide(!1)
                        })
                    }()
                }
            ...
            methods: {
                            ...
                            if (n.toggle = e || n.toggle, n.clearTimers(), !n.isActive())
                                if (i && Xi && Xi !== n && Xi.isDelaying)
                                    ...
                                    if (n.isParentOf(Xi)) {
                                        ...
                                        for (var t; Xi && Xi !== t && !n.isChildOf(Xi);)
                                            (t = Xi).hide(!1);
                ...
                position: function() {
                    ...
                    if ("justify" === this.align) {
                        ...
                        this.$el.offsetWidth > Math.max(t.right - e.left, e.right - t.left) && xe(this.$el, this.clsDrop + "-stack");
                ...
                if (this.masonry && this.length) {
                    ...
                    l = r.reduce(function(i, t, n) {
                        return i[n] = t.map(function(t, e) {
                            return 0 === n ? 0 : H(i[n - 1][e]) + (c - H(r[n - 1][e] && r[n - 1][e].offsetHeight))
                    ...
                    }, [])) + (e = this.$el, i = this.margin, n = j(e.children), H((o = n.filter(function(t) {
                        return Se(t, i)
    ...
    function cn(t) {
        ...
        return o && s && (Me(t, "minHeight", ""), e = un(t), n = e.heights, r = e.max), {
            heights: n = t.map(function(t, e) {
                return n[e] === r && H(t.style.minHeight) !== r ? "" : r
            }),
            elements: t
        }
    }
    ...
    var dn = {
        ...
        update: {
            read: function() {
                ...
                if (this.expand)
                    t = Qe(window) - (fn(document.documentElement) - fn(this.$el)) - e || "";
                else {
                    if (t = "calc(100vh", this.offsetTop) {
                        var i = Ge(this.$el).top;
                        t += i < Qe(window) / 2 ? " - " + i + "px" : ""
                    }
                    !0 === this.offsetBottom ? t += " - " + fn(this.$el.nextElementSibling) + "px" : O(this.offsetBottom) ? t += " - " + this.offsetBottom + "vh" : this.offsetBottom && u(this.offsetBottom, "px") ? t += " - " + H(this.offsetBottom) + "px" : N(this.offsetBottom) && (t += " - " + fn(it(this.offsetBottom, this.$el)) + "px"), t += (e ? " - " + e + "px" : "") + ")"
                }
                return {
                    minHeight: t
                }
            ...
            write: function(t) {
                ...
                Me(this.$el, {
                    minHeight: e
                }), this.minHeight && H(Me(this.$el, "minHeight")) < this.minHeight && Me(this.$el, "minHeight", this.minHeight)
            },
            events: ["load", "resize"]
        }
    };
            ...
            connected: function() {
                ...
                this.svg = this.getSvg().then(function(t) {
                    ...
                    if (N(t) ? (a.icon && b(t, "<symbol") && (t = function(t, e) {
                        if (!vn[t]) {
                            var i;
                            for (vn[t] = {}; i = gn.exec(t);)
                                vn[t][i[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + i[1] + "svg>";
                            gn.lastIndex = 0
                        }
                        return vn[t][e]
                    }(t, a.icon) || t), e = we(t.substr(t.indexOf("<svg")))) : e = t.cloneNode(!0), !e)
                        return zt.reject("SVG not found.");
                    var i = Z(e, "viewBox");
                    ...
                    if (!n && this.target.some(function(t) {
                        ...
                        return {
                            image: Vt(this.dataSrc, this.dataSrcset, this.sizes).then(function(t) {
                                return En(e.$el, Dn(t), t.srcset, t.sizes), zn[e.cacheKey] = Dn(t), t
                            }, X)
                        };
                    !this.isImg && n && n.then(function(t) {
                        return t && En(e.$el, Dn(t))
                    })
                }
            },
            write: function(t) {
                if (!t.delay)
                    return this.$emit(), t.delay = !0
            },
            events: ["scroll", "load", "resize"]
        }
    };
    function En(t, e, i, n) {
        if (Bn(t))
            ...
            Me(t, "backgroundImage", "url(" + e + ")"), r && At(t, _t("load", !1))
        }
    }
    ...
    var An = /\d+(?:\w+|%)/g,
        _n = /[+-]?(\d+)/g;
    function Nn(t, e, i) {
        return void 0 === e && (e = "width"), void 0 === i && (i = window), O(t) ? +t : u(t, "vw") ? On(i, "width", t) : u(t, "vh") ? On(i, "height", t) : u(t, "%") ? On(i, e, t) : H(t)
    }
    var Mn = {
        height: Qe,
        width: ti
    ...
    var zn,
        Hn = "__test__";
    try {
        (zn = window.sessionStorage || {})[Hn] = 1, delete zn[Hn]
    } catch (t) {
        zn = {}
    }
    var Pn = {
        ...
        Vn = {
            ...
            computed: {
                ...
                transitionDuration: function() {
                    return F(Me(this.transitionElement, "transitionDuration"))
                },
                bgClose: function(t) {
            ...
            methods: {
                ...
                show: function() {
                    return this.isToggled() ? zt.resolve() : (this.container && this.$el.parentNode !== this.container && (se(this.container, this.$el), this._callConnected()), this.toggleNow(this.$el, !0))
                },
                hide: function() {
    ...
    var Rn,
        ...
        Un = {
            ...
            events: [{
                ...
                handler: function(t, e) {
                    var i = e.$el,
                        n = e.dir;
                    this.clsDrop && xe(i, this.clsDrop + "-dropbar"), "bottom" === n && this.transitionTo(i.offsetHeight + H(Me(i, "marginTop")) + H(Me(i, "marginBottom")), i)
                }
            }, {
                name: "beforehide",
                filter: function() {
            ...
            methods: {
                ...
                transitionTo: function(t, e) {
                    var i = this,
                        n = this.dropbar,
                        r = xt(n) ? Qe(n) : 0;
                    return Me(e = r < t && e, "clip", "rect(0," + e.offsetWidth + "px," + r + "px,0)"), Qe(n, r), Fe.cancel([e, n]), zt.all([Fe.start(n, {
                        height: t
        ...
        Xn = {
            ...
            update: {
                write: function() {
                    this.getActive() === this && ((this.overlay || this.clsContentAnimation) && ti(this.content, ti(window) - this.scrollbarWidth), this.overlay && (Qe(this.content, Qe(window)), Rn && (this.content.scrollTop = Rn.y)))
                },
                events: ["resize"]
            },
            events: [{
                ...
                handler: function(t) {
                    var e = t.current;
                    e.hash && we(e.hash, this.content) && (Rn = null, this.hide())
                }
            }, {
                name: "beforescroll",
                filter: function() {
                ...
                handler: function(t, e, i) {
                    e && i && this.isToggled() && we(i, this.content) && (Ct(this.$el, "hidden", function() {
                        return e.scrollTo(i)
                    }), t.preventDefault())
                }
            }, {
                ...
                handler: function() {
                    ...
                    ke(this.panel, this.clsSidebarAnimation, this.clsMode), ke(this.$el, this.clsOverlay), Me(this.$el, "display", ""), ke(document.body, this.clsContainer, this.clsFlip, this.clsOverlay), document.body.scrollTop = Rn.y, Me(document.documentElement, "overflowY", ""), ti(this.content, ""), Qe(this.content, ""), window.scroll(Rn.x, Rn.y), Rn = null
                }
            }, {
                name: "swipeLeft swipeRight",
                handler: function(t) {
                    this.isToggled() && Bi(t) && ("swipeLeft" === t.type && !this.flip || "swipeRight" === t.type && this.flip) && this.hide()
                }
            }]
        },
        Kn = {
            ...
            update: {
                read: function() {
                    return !(!this.content || !this.container) && {
                            current: H(Me(this.$el, "maxHeight")),
    ...
    var Zn = {
            ...
            update: [{
                ...
                read: function(o) {
                    ...
                    o.active = !1, this.targets.every(function(t, e) {
                        ...
                        if (!s.overflow && (0 === e && a < i || n && i + t.offsetTop < a))
                            return !1;
                        if (!n && Ge(s.targets[e + 1]).top <= a)
                            return !0;
                        if (l <= a)
        ...
        tr = {
                    ...
                    if (!1 !== this.targetOffset && location.hash && 0 < window.pageYOffset) {
                        ...
                        r && fi.read(function() {
                            var t = Ge(r).top,
                                e = Ge(n.$el).top,
                                i = n.$el.offsetHeight;
                            n.isActive && t <= e + i && e <= t + r.offsetHeight && hi(window, t - i - (O(n.targetOffset) ? n.targetOffset : 0) - n.offset)
                        })
                    }
                }
            }],
            update: [{
                read: function(t) {
                    var e = t.height;
                    this.topOffset = Ge(this.isActive ? this.placeholder : this.$el).top, this.bottomOffset = this.topOffset + e;
                    var i = er("bottom", this);
                    return this.top = Math.max(H(er("top", this)), this.topOffset) - this.offset, this.bottom = i && i - e, this.inactive = !this.matchMedia, {
                        height: this.isActive ? e : this.$el.offsetHeight,
                ...
                write: function(t) {
                    ...
                    Me(n, Y({
                        height: e
                    }, i)), St(n, document) || (le(this.$el, n), Z(n, "hidden", "")), B(this.isActive) && this.hide()
                },
                events: ["load", "resize"]
            }, {
                read: function(t, e) {
                ...
                write: function(t, e) {
                    ...
                    if (!(r < 0 || !n || this.disabled || this.showOnUp && !o))
                        if (this.inactive || r < this.top || this.showOnUp && (r <= this.top || "down" === o || "up" === o && !this.isActive && r <= this.bottomOffset)) {
                            ...
                            this.isActive ? this.update() : this.animation ? (Ue.cancel(this.$el), this.show(), Ue.in(this.$el, this.animation).catch(X)) : this.show()
                },
                events: ["load", "resize", "scroll"]
            }],
            methods: {
    ...
    var ir,
        nr = {
            ...
            events: [{
                ...
                handler: function(t) {
                    Bi(t) && (t.preventDefault(), window.getSelection().toString() || this.show("swipeLeft" === t.type ? "next" : "previous"))
                }
            }],
            update: function() {
                var e = this;
        ...
        or = {
            ...
            events: [{
                ...
                handler: function(t) {
                    Bi(t) || this.toggle("toggle" + (t.type === Zt ? "show" : "hide"))
                }
            }, {
                name: "click",
                filter: function() {
                ...
                handler: function(t) {
                    var e;
                    (Bi(t) || b(this.mode, "click")) && ((mt(t.target, 'a[href="#"], button') || (e = mt(t.target, "a[href]")) && (this.cls || !xt(this.target) || e.hash && ft(this.target, e.hash))) && Ct(document, "click", function(t) {
        ...
        hr = {
            ...
            methods: {
                animate: function(t) {
                    ...
                    t(), Fe.cancel(this.target), r.forEach(Fe.cancel), ur(this.target), this.$update(this.target), fi.flush();
                    ...
                    return o = a.map(function(t, e) {
                        ...
                        return o[e] && a[e] ? Fe.start(t, a[e], n.animation, "ease") : zt.resolve()
                ...
                this.toggles.forEach(function(t) {
                    return Te(t, c.cls, function(t, e, i) {
                        ...
                        var c = a.sort,
                            u = a.order;
                        void 0 === u && (u = "asc");
                        return Boolean((l || B(c)) && h in n && (l === n[h] || B(l) && !n[h]) || o && c && o === c && s === u)
                    }(t, c.attrItem, h))
                });
                var e = function() {
                    var t,
    ...
    function mr(t, s, a) {
        return j(t).forEach(function(t) {
            var e = pr(t, s),
                ...
                r = e.sort,
                o = e.order;
            void 0 === o && (o = "asc"), (i || B(r)) && (n ? (delete a.filter[""], a.filter[n] = i) : a.filter = {
                "": i
            }), B(r) || (a.sort = [r, o])
        }), a
    }
    ...
    var $r = {
        mixins: [{
            ...
            events: [{
                ...
                handler: function(t) {
                    var e;
                    !Bi(t) && (!(e = t.target).children.length && e.childNodes.length) || 0 < t.button || this.length < 2 || this.preventCatch || this.start(t)
                }
            }, {
                name: "touchmove",
                passive: !1,
        ...
        methods: {
                ...
                if (void 0 === e && (e = !1), !this.dragging && this.length) {
                    ...
                    if (n[e ? "unshift" : "push"](t), !e && 1 < n.length)
                        ...
                        if (a !== h) {
                            var c,
                                u;
                            if (this.dir = (u = s, "next" === (c = t) ? 1 : "previous" === c ? -1 : c < u ? -1 : 1), this.prevIndex = s, this.index = l, a && At(a, "beforeitemhide", [this]), !At(h, "beforeitemshow", [this, a]))
            ...
            _show: function(t, e, i) {
                ...
                }, this.transitionOptions)), !i && !t)
                    return this._transitioner.translate(1), zt.resolve();
    ...
    var Sr = {
        ...
        Tr = {
            ...
            events: [{
                ...
                self: !0,
                handler: function() {
                    this.hideControls(), ke(this.slides, this.clsActive), Fe.stop(this.slides)
                }
            }, {
                name: "keyup",
                el: document,
                ...
                handler: function(t, r) {
                    ...
                    if (this.setItem(r, "<span uk-spinner></span>"), e)
                        if ("image" === i || e.match(/\.(jp(e)?g|png|gif|svg)($|\?)/i))
                            ...
                            this.setItem(r, '<iframe class="uk-lightbox-iframe" src="' + e + '" frameborder="0" allowfullscreen></iframe>');
                            ...
                            (o = e.match(/(\/\/.*?)vimeo\.[a-z]+\/([0-9]+).*?/)) && Ft("https://vimeo.com/api/oembed.json?maxwidth=1920&url=" + encodeURI(e), {
                                responseType: "json",
                                withCredentials: !1
                            }).then(function(t) {
                                var e = t.response,
        ...
        Nr = {
            ...
            methods: {
                close: function(t) {
                    ...
                    this.timer && clearTimeout(this.timer), t ? i() : Fe.start(this.$el, {
                        opacity: 0,
                        marginTop: -this.$el.offsetHeight,
                        marginBottom: 0
                    }).then(i)
    ...
    var Mr = ["x", "y", "bgx", "bgy", "rotate", "scale", "color", "backgroundColor", "borderColor", "opacity", "blur", "hue", "grayscale", "invert", "saturate", "sepia", "fopacity"],
        Or = {
            ...
            update: {
                read: function(t) {
                    var e = this;
                    if (t.active = this.matchMedia, t.dimEl = {
                        width: this.$el.offsetWidth,
                        height: this.$el.offsetHeight
                    }, !("image" in t) && this.covers && this.bgProps.length) {
                        var i = Me(this.$el, "backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/, "$1");
                        if (i) {
                            var n = new Image;
                            n.src = i, (t.image = n).naturalWidth || (n.onload = function() {
                                return e.$emit()
                            })
                        }
                    }
                    ...
                    return Object.keys(m).reduce(function(t, e) {
                        ...
                        case "y":
                            ...
                            var a = ["x", "y"].map(function(t) {
                                    return e === t ? H(s).toFixed(0) + r : m[t] ? Dr(m[t].steps, p, 0) + m[t].unit : 0
                                }),
                                l = a[0],
                                h = a[1];
    ...
    function Pr(t, e, i) {
        var n,
            r = Wr(t, e);
        return i ? r - (n = t, Fr(e).width / 2 - Fr(n).width / 2) : Math.min(r, Lr(e))
    }
    function Lr(t) {
        return Math.max(0, jr(t) - Fr(t).width)
    }
    function jr(t) {
    ...
    function Wr(t, e) {
        return (Ze(t).left + (Rt ? Fr(t).width - Fr(e).width : 0)) * (Rt ? -1 : 1)
    }
    function Fr(t) {
    ...
    var Rr = {
            ...
            data: {
                ...
                Transitioner: function(r, n, o, t) {
                    var e = t.center,
                        ...
                        a = t.list,
                        l = new Ht,
                        i = r ? Pr(r, a, e) : Pr(n, a, e) + Fr(n).width * o,
                        h = n ? Pr(n, a, e) : i + Fr(r).width * o * (Rt ? -1 : 1);
                    return {
                        dir: o,
                        show: function(t, e, i) {
                            void 0 === e && (e = 0);
                        ...
                        translate: function(t) {
                            ...
                            Me(a, "transform", br(U(e - e * t - h, -jr(a), Fr(a).width) * (Rt ? -1 : 1), "px")), this.updateTranslates(), r && (t = U(t, -1, 1), Vr(this.getItemIn(), "itemtranslatein", {
                                percent: t,
                                dir: o
                        ...
                        getActives: function() {
                            ...
                            return q(Yr(a).filter(function(t) {
                                var e = Wr(t, a);
                                return i <= e && e + Fr(t).width <= Fr(a).width + i
                            }), "offsetLeft")
                        },
            ...
            computed: {
                ...
                finite: function(t) {
                    return t.finite || jr(this.list) < Fr(this.list).width + Yr(this.list).reduce(function(t, e) {
                            return Math.max(t, Fr(e).width)
                        }, 0) + this.center
                },
                maxIndex: function() {
                    ...
                    for (var t = Lr(this.list), e = this.length; e--;)
                        if (Wr(this.list.children[e], this.list) < t)
                ...
                sets: function(t) {
                    var o = this,
                        e = t.sets,
                        s = Fr(this.list).width / (this.center ? 2 : 1),
                        a = 0,
                        l = s,
                        h = 0;
                    return (e = e && this.slides.reduce(function(t, e, i) {
                            ...
                            if (a < h + n && (!o.center && i > o.maxIndex && (i = o.maxIndex), !b(t, i))) {
                                var r = o.slides[i + 1];
                                o.center && r && n < l - Fr(r).width / 2 ? l -= n : (l = s, t.push(i), a = h + s + (o.center ? n / 2 : 0))
                            }
                            return h += n, t
                        }, [])) && e.length && e
                },
            ...
            update: {
                write: function() {
                    ...
                    be("[" + this.attrItem + "],[data-" + this.attrItem + "]", this.$el).forEach(function(t) {
                        var e = et(t, i.attrItem);
                        i.maxIndex && Te(t, "uk-hidden", O(e) && (i.sets && !b(i.sets, H(e)) || e > i.maxIndex))
                    })
                },
                events: ["load", "resize"]
            },
            events: {
                beforeitemshow: function(t) {
                    ...
                    if (!this.dragging && 1 < e) {
                        ...
                        this.duration = Ir(this.avgWidth / this.velocity) * (Fr(this.dir < 0 || !this.slides[this.prevIndex] ? this.slides[this.index] : this.slides[this.prevIndex]).width / this.avgWidth), this.reorder()
                },
                itemshow: function() {
                ...
                itemshown: function() {
                    ...
                    }), (!this.sets || b(this.sets, H(this.index))) && this.slides.forEach(function(t) {
                ...
                reorder: function() {
                    ...
                    if (Me(this.slides, "order", ""), !this.finite) {
                        ...
                        if (this.slides.forEach(function(t, e) {
                            ...
                            for (var t = this.slides[n], e = Fr(this.list).width / 2 - Fr(t).width / 2, r = 0; 0 < e;) {
                                var o = i.getIndex(--r + n, n),
                                    s = i.slides[o];
                                Me(s, "order", n < o ? -2 : -1), e -= Fr(s).width
                            }
                    }
                },
                getValidIndex: function(t, e) {
                    var i;
                    if (void 0 === t && (t = this.index), void 0 === e && (e = this.prevIndex), t = this.getIndex(t, e), !this.sets)
                        return t;
                    do {
                        if (b(this.sets, t))
                            return t;
            ...
            events: [{
                ...
                handler: function(t) {
                    var e = t.type,
                        ...
                        o = i.timing,
                        s = i.dir;
                    Fe.cancel(this.$el), Me(this.$el, this.getCss(Xr(e, s, n))), Fe.start(this.$el, this.getCss(Ur(e) ? .5 : 0 < s ? 1 : 0), r, o).catch(X)
                }
            }, {
                ...
                handler: function(t) {
                    var e = t.type,
                        ...
                        n = i.percent,
                        r = i.dir;
                    Fe.cancel(this.$el), Me(this.$el, this.getCss(Xr(e, r, n)))
                }
            }]
        };
    function Ur(t) {
            ...
            update: {
                write: function() {
                    if (this.clsEmpty && Te(this.$el, this.clsEmpty, !this.$el.children.length), Me(this.handle ? be(this.handle, this.$el) : this.$el.children, "touchAction", "none"), this.drag) {
                        ...
                        0 < e && e < this.scrollY ? t = this.scrollY - 5 : i < Qe(document) && i > Qe(window) + this.scrollY && (t = this.scrollY + 5), t && setTimeout(function() {
                            return hi(window, t)
                        }, 5)
                    }
                }
            ...
            methods: {
                ...
                scroll: function() {
                    ...
                    if (Et(document, Gt, this.move), Et(document, Jt, this.end), Et(window, "scroll", this.scroll), this.drag) {
                        ...
                        "mouseup" !== t.type && St(t.target, "a[href]") && (location.href = mt(t.target, "a[href]").href)
                },
                insert: function(i, n) {
                    var r = this;
